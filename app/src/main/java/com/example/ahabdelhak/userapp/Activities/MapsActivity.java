...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        CheckVersion_EnableLocation();
    }

    //Note Version up M needs Permission down doesn't need
    private void CheckVersion_EnableLocation() {
    ...
    public void onLocationChanged(Location location) {
        ...
        GetUsercurrentLocation(location);
    }

    //Get Current Location with marker
    private void GetUsercurrentLocation(Location Ulocation) {
